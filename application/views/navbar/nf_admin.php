            ...
            <div class="nano">
                <div class="nano-content">
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <!--Menu list item-->
                        <li <?php if($page=='main') echo 'class="active-link"'; ?>>
                        ...
                        <li >
                            <a href="<?php echo site_url('exel');?>">
                                <i class="fa fa-file-excel-o"></i>
                                <span class="menu-title">
                                    <strong>В Excel</strong>
                                    <!-- <span class="label label-success pull-right">Top</span> -->
                                </span>
                            </a>
                        </li>
                        ...
                        {
                            ?>
                            <li <?php if($page=='users') echo 'class="active-link"'; ?>>
                            ...
                            <li <?php if($page=='adminpanel') echo 'class="active-link"'; ?>>
